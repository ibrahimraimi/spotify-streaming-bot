...
os.system(f"title Metro's - Spotify Streaming bot v1 ")

url = "https://github.com/ibrahimraimi/spotify-streaming-bot/"

def check_for_updates():
    try:
        r = requests.get("https://raw.githubusercontent.com/ibrahimraimi/spotify-streaming-bot/main/version.txt")
...
def print_announcement():
    try:
        r = requests.get("https://raw.githubusercontent.com/ibrahimraimi/spotify-streaming-bot/main/announcement.txt", headers={"Cache-Control": "no-cache"})
...
def main():
    ...
    print(Colorate.Vertical(Colors.red_to_blue, Center.XCenter("""
                    ...
                    __  __ ______ _______ _____   ____  
                    |  \/  |  ____|__   __|  __ \ / __ \ 
                    | \  / | |__     | |  | |__) | |  | |
                    | |\/| |  __|    | |  |  _  /| |  | |
                    | |  | | |____   | |  | | \ \| |__| |
 ...
 Improvements can be made to the code. If you're getting an error, visit my discord.  
                             Github  github.com/ibrahimraimi
                             Discord discord.gg/thegreat.metro """)))
    print("")
